...
///
@usableFromInline protocol RadixSolution<Size> {
    ...
    @inlinable var solution: AnyRadixSolution<Size> { get }
...
@frozen @usableFromInline struct PerfectRadixSolution<Size>: RadixSolution where Size: NBKCoreInteger & NBKSignedInteger {
    
    //=------------------------------------------------------------------------=
    // MARK: State
    //=------------------------------------------------------------------------=
    
    public let solution: AnyRadixSolution<Size>
    
    //=------------------------------------------------------------------------=
    // MARK: Initializers
    //=------------------------------------------------------------------------=
    
    @inlinable public init?(_ solution: AnyRadixSolution<Size>) {
    ...
    @frozen @usableFromInline struct Division {
        ...
        @inlinable init(_ solution: PerfectRadixSolution<Size>) {
...
@frozen @usableFromInline struct ImperfectRadixSolution<Size>: RadixSolution where Size: NBKCoreInteger & NBKSignedInteger {
    ...
    @frozen @usableFromInline struct Division {
        ...
        @inlinable init(_ solution: ImperfectRadixSolution<Size>) {
...
@frozen @usableFromInline struct AnyRadixSolution<Size>: RadixSolution where Size: NBKCoreInteger & NBKSignedInteger {
    ...
    @inlinable public init(_ other: some RadixSolution<Size>) {
        self = other.solution
    }
    ...
    @inlinable public var solution: AnyRadixSolution<Size> { self }
    ...
    @frozen @usableFromInline struct Division {
        ...
        @inlinable init(_ solution: AnyRadixSolution<Size>) {
