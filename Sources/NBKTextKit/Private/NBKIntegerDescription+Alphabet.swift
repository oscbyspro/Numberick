...
//*========================================================================*
// MARK: * NBK x Integer Description x Alphabet x Decoder x Any
//*========================================================================*

/// Decodes values in `0` to `36` from ASCII.
@frozen @usableFromInline struct NBKIntegerDescriptionAnyAlphabetDecoder {
...
//*========================================================================*
// MARK: * NBK x Integer Description x Alphabet x Encoder x Max
//*========================================================================*

/// Encodes values in `0` to `36` to ASCII.
@frozen @usableFromInline struct NBKIntegerDescriptionMaxAlphabetEncoder {
