...
public protocol IntXROrUIntXR: NBKBinaryInteger, ExpressibleByStringLiteral,
MutableCollection, RandomAccessCollection where Magnitude == UIntXR, Element == UInt,
Index == Int, Indices == Range<Int> {
