...
final class Int256TestsOnText: XCTestCase {
    ...
    func testDecodingStringsWithOrWithoutSignAndRadixLiteral() throws {
        ...
        //XCTAssertEqual(T( "1234567890"),          1234567890        )
        //XCTAssertEqual(T( "0x123456789abcdef0"),  0x123456789abcdef0)
        //XCTAssertEqual(T( "0o1234567012345670"),  0o1234567012345670)
        //XCTAssertEqual(T( "0b1010101010101010"),  0b1010101010101010)
