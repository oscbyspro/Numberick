...
final class NBKDoubleWidthTestsOnShiftsAsInt256: XCTestCase {
    ...
    func testBitShiftingLeftByBits() {
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)),   0, T(x64: X64( 1,  2,  3,  4)))
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)),   1, T(x64: X64( 2,  4,  6,  8)))
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)),   2, T(x64: X64( 4,  8, 12, 16)))
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)),   3, T(x64: X64( 8, 16, 24, 32)))
    }
    
    func testBitShiftingLeftByWords() {
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)),   0, T(x64: X64( 1,  2,  3,  4)))
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)),  64, T(x64: X64( 0,  1,  2,  3)))
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)), 128, T(x64: X64( 0,  0,  1,  2)))
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)), 192, T(x64: X64( 0,  0,  0,  1)))
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)), 256, T(x64: X64( 0,  0,  0,  0)))
    }
    
    func testBitShiftingLeftByWordsAndBits() {
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)),   3, T(x64: X64( 8, 16, 24, 32)))
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)),  67, T(x64: X64( 0,  8, 16, 24)))
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)), 131, T(x64: X64( 0,  0,  8, 16)))
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)), 195, T(x64: X64( 0,  0,  0,  8)))
        NBKAssertShiftLeft(T(x64: X64( 1,  2,  3,  4)), 259, T(x64: X64( 0,  0,  0,  0)))
    }
    
    func testBitShiftingLeftSuchThatWordsSplit() {
        NBKAssertShiftLeft(T(x64: X64(~0,  0,  0,  0)),   1, T(x64: X64(~1,  1,  0,  0)))
        NBKAssertShiftLeft(T(x64: X64( 0, ~0,  0,  0)),   1, T(x64: X64( 0, ~1,  1,  0)))
        NBKAssertShiftLeft(T(x64: X64( 0,  0, ~0,  0)),   1, T(x64: X64( 0,  0, ~1,  1)))
        NBKAssertShiftLeft(T(x64: X64( 0,  0,  0, ~0)),   1, T(x64: X64( 0,  0,  0, ~1)))
    }
    ...
    func testBitShiftingRightByBits() {
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)),   0, T(x64: X64( 8, 16, 24, 32)))
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)),   1, T(x64: X64( 4,  8, 12, 16)))
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)),   2, T(x64: X64( 2,  4,  6,  8)))
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)),   3, T(x64: X64( 1,  2,  3,  4)))
    }
    
    func testBitShiftingRightByWords() {
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)),   0, T(x64: X64( 8, 16, 24, 32)))
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)),  64, T(x64: X64(16, 24, 32,  0)))
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)), 128, T(x64: X64(24, 32,  0,  0)))
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)), 192, T(x64: X64(32,  0,  0,  0)))
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)), 256, T(x64: X64( 0,  0,  0,  0)))
    }
    
    func testBitShiftingRightByWordsAndBits() {
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)),   3, T(x64: X64( 1,  2,  3,  4)))
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)),  67, T(x64: X64( 2,  3,  4,  0)))
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)), 131, T(x64: X64( 3,  4,  0,  0)))
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)), 195, T(x64: X64( 4,  0,  0,  0)))
        NBKAssertShiftRight(T(x64: X64(8, 16, 24, 32)), 259, T(x64: X64( 0,  0,  0,  0)))
    }
    
    func testBitShiftingRightSuchThatWordsSplit() {
        NBKAssertShiftRight(T(x64: X64(0,  0,  0,  7)),   1, T(x64: X64( 0,  0,  1 << 63,  3)))
        NBKAssertShiftRight(T(x64: X64(0,  0,  7,  0)),   1, T(x64: X64( 0,  1 << 63,  3,  0)))
        NBKAssertShiftRight(T(x64: X64(0,  7,  0,  0)),   1, T(x64: X64( 1 << 63,  3,  0,  0)))
        NBKAssertShiftRight(T(x64: X64(7,  0,  0,  0)),   1, T(x64: X64( 3,        0,  0,  0)))
    }
    
    func testBitShiftingRightIsSigned() {
        NBKAssertShiftRight(T(x64: X64(0, 0, 0, 1 << 63)),   0, T(x64: X64( 0,  0,  0,  1 << 63)))
        NBKAssertShiftRight(T(x64: X64(0, 0, 0, 1 << 63)),  64, T(x64: X64( 0,  0,  1 << 63, ~0)))
        NBKAssertShiftRight(T(x64: X64(0, 0, 0, 1 << 63)), 128, T(x64: X64( 0,  1 << 63, ~0, ~0)))
        NBKAssertShiftRight(T(x64: X64(0, 0, 0, 1 << 63)), 192, T(x64: X64( 1 << 63, ~0, ~0, ~0)))
        NBKAssertShiftRight(T(x64: X64(0, 0, 0, 1 << 63)), 256, T(x64: X64(~0,       ~0, ~0, ~0)))
    }
    ...
    func testBitShiftingIsSmart() {
        XCTAssertEqual(T(x64: X64(1, 2, 3, 4)) <<   1, T(x64: X64(2, 4, 6, 8)))
        XCTAssertEqual(T(x64: X64(1, 2, 3, 4)) >>  -1, T(x64: X64(2, 4, 6, 8)))
        
        XCTAssertEqual(T(x64: X64(1, 2, 3, 4)) <<  64, T(x64: X64(0, 1, 2, 3)))
        XCTAssertEqual(T(x64: X64(1, 2, 3, 4)) >> -64, T(x64: X64(0, 1, 2, 3)))
    }
    ...
    func testBitShiftingByMaskingIsEquivalentToBitShiftingModuloBitWidth() {
        NBKAssertShiftLeftByMasking (T(x64: X64(1, 2, 3, 4)),  256, T(x64: X64(1, 2, 3, 4)), signitude: S.self)
        NBKAssertShiftLeftByMasking (T(x64: X64(1, 2, 3, 4)), -256, T(x64: X64(1, 2, 3, 4)), signitude: S.self)
        
        NBKAssertShiftLeftByMasking (T(x64: X64(1, 2, 3, 4)),  257, T(x64: X64(2, 4, 6, 8)), signitude: S.self)
        NBKAssertShiftLeftByMasking (T(x64: X64(1, 2, 3, 4)), -255, T(x64: X64(2, 4, 6, 8)), signitude: S.self)
        
        NBKAssertShiftLeftByMasking (T(x64: X64(1, 2, 3, 4)),  320, T(x64: X64(0, 1, 2, 3)), signitude: S.self)
        NBKAssertShiftLeftByMasking (T(x64: X64(1, 2, 3, 4)), -192, T(x64: X64(0, 1, 2, 3)), signitude: S.self)
        
        NBKAssertShiftRightByMasking(T(x64: X64(2, 4, 6, 8)),  256, T(x64: X64(2, 4, 6, 8)), signitude: S.self)
        NBKAssertShiftRightByMasking(T(x64: X64(2, 4, 6, 8)), -256, T(x64: X64(2, 4, 6, 8)), signitude: S.self)
        
        NBKAssertShiftRightByMasking(T(x64: X64(2, 4, 6, 8)),  257, T(x64: X64(1, 2, 3, 4)), signitude: S.self)
        NBKAssertShiftRightByMasking(T(x64: X64(2, 4, 6, 8)), -255, T(x64: X64(1, 2, 3, 4)), signitude: S.self)
        
        NBKAssertShiftRightByMasking(T(x64: X64(2, 4, 6, 8)),  320, T(x64: X64(4, 6, 8, 0)), signitude: S.self)
        NBKAssertShiftRightByMasking(T(x64: X64(2, 4, 6, 8)), -192, T(x64: X64(4, 6, 8, 0)), signitude: S.self)
    }
}
