...
final class NBKResizableWidthTestsOnLogicAsUIntXR: XCTestCase {
    ...
    func testOperationsHaveUpsizingSemantics() {
        NBKAssertAnd(T(words:[0   ] as W), T(words:[0, 0] as W), T(words:[0, 0] as W))
        NBKAssertAnd(T(words:[0, 0] as W), T(words:[0   ] as W), T(words:[0, 0] as W))
        
        NBKAssertOr (T(words:[0   ] as W), T(words:[0, 0] as W), T(words:[0, 0] as W))
        NBKAssertOr (T(words:[0, 0] as W), T(words:[0   ] as W), T(words:[0, 0] as W))
        
        NBKAssertXor(T(words:[0   ] as W), T(words:[0, 0] as W), T(words:[0, 0] as W))
        NBKAssertXor(T(words:[0, 0] as W), T(words:[0   ] as W), T(words:[0, 0] as W))
    }
}

//*============================================================================*
// MARK: * NBK x Resizable Width x Logic x Assertions
//*============================================================================*
